...
public class HotelManagement {
    ...
    public void updateHotel() {
        ...
        if (hotel == null) {
            ...
            System.out.println(ConsoleColors.RED + cm.HOTEL_ID_IS_EXISTED + ConsoleColors.RESET);
    ...
    public void searchHotelByName() {
        ...
        for (HotelModel hotelModel : hotelList) {
            if (hotelModel.getHotel_Name().equals(hotel_Name)) {
                hotelModel.showInfo();
                isExisted = true;
            }
        }
        if (!isExisted) {
            System.out.println(cm.HOTEL_NAME_IS_NOT_EXISTED);
        } else {
            System.out.println(cm.HOTEL_NAME_IS_EXISTED);
        }
    }
